...
//    Default accuracy = 0.1 %
    ...
    value_1 = mult_icomputations(-100, 100, -100, 100, cur_partition, thr);
    do {
       value_2 = mult_icomputations(-100, 100, -100, 100, cur_partition * 2, thr);
       cur_partition *= 2;
...
int main() {
    cout << mult_icomputations(-100, 100 , -100, 100, ma(1), 5 ) << endl;
